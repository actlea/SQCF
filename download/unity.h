...
const string COACHN = file + "coachname.txt";//国家足球队教练表格
const string NCOACHN = file + "ncoachname.txt";//国家足球队教练表格处理后的信息
const string NFTPAGE = file + "nationalTeam.txt";	//NFT网页
//网址
...
enum URL{CONTINENT,COUNTRY,PLAYER,HOME};
//返回str中tag的个数
/*
