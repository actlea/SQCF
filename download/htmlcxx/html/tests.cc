...
class HtmlTest {
	...
	bool string_manip() {
		...
		myassert(HTML::decode_entities(entities) == "nos somos do clube atletico mineiro ??brasil   &teste; ãä &aacute ?&end   ");
...
class CharsetTest
{
	public:
		void test()
		{
			...
			myassert(cc.convert("VocÃª Ã© o meu visitante nÃºmero") == "Voc??o meu visitante número");
		}
};
